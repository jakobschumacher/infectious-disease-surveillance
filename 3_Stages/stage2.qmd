...
If there are several events that are looked at, that are collected via different methods the term: "enhanced" or "intensivied" are used, especially in a mass-gathering surveillance. If collection methods by  veteniary or food-safety agencies are included the term "integrated" or "one-health" is applied.  
