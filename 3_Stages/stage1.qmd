...
subtitle: If you are clear about your objectives everythin will be easier.
---



```{r, content-visible when-format="html", echo=FALSE, message=FALSE, warning=FALSE, error=FALSE}
source("../graphs.R")
create_surveillance_plot(highlight = "Stage 1", output_type = "plotly", language = "en")
```
