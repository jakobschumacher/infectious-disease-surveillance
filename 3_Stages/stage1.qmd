---
title: "Infection Event (Stage 1)"
---

Surveillance systems monitor a wide range of infection-related events. The choice of events to monitor in a surveillance system is a critical decision that shapes the system's in many ways. Understanding the event is essential for understanding a surveillance system.
...
## The choice of event
The choice of an event for a surveillance system depends on the Objective of the surveillance system. 
...
- If only goup-based intervention is inteded a trend is needed which can be acquired by wastewater
