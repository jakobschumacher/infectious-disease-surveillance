...
|Content|This presentation gives an overview of the steps of an surveillance system. |
|Time|10 Minutes|
|Language|English|
|Intended audience|Young professionals, Fellows of the European programme for intervention epidemiology| 
|Learning objectives| (1) Understand that the definition of surveillance includes most steps (2) The steps are: Events, Collection, Classification, Data management, Analysis, Communication, Action|
